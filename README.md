...
The `templates/` folder has blank JSON templates for all 9 classes, pre-filled with class-specific starting stats (domains, evasion, HP, class features, hope feature).
